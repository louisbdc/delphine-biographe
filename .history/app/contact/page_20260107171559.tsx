            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="relative">
                  <label htmlFor="name" className="block text-sm font-medium text-navy/70 mb-2">Votre Nom</label>
                  <input 
                    type="text" 
                    id="name"
                    placeholder="Jean Dupont"
                    className="w-full px-4 py-3 rounded-lg bg-[#FDFBF7] border-2 border-transparent focus:border-gold/30 focus:bg-white focus:outline-none transition-all duration-300 placeholder:text-navy/20 text-navy"
                  />
                </div>

                {/* Champ Email */}
                <div className="relative">
                  <label htmlFor="email" className="block text-sm font-medium text-navy/70 mb-2">Votre Email</label>
                  <input 
                    type="email" 
                    id="email"
              ...
              {/* Champ Message (Large) */}
              <div className="relative">
                <label htmlFor="message" className="block text-sm font-medium text-navy/70 mb-2">Votre Message</label>
                <textarea 
                  id="message"
                  rows={5}
                  placeholder="Racontez-moi votre projet..."
                  className="w-full px-4 py-3 rounded-lg bg-[#FDFBF7] border-2 border-transparent focus:border-gold/30 focus:bg-white focus:outline-none transition-all duration-300 placeholder:text-navy/20 text-navy resize-none"
                ></textarea>
              </div>
