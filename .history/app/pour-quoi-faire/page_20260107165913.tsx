          ...
          <div className="grid md:grid-cols-12 gap-12 items-center">
            ...
            <div className="md:col-span-7 order-2 md:order-1">
              ...
              <p className="text-2xl md:text-3xl font-serif text-navy mb-6 font-light">
                <span className="italic">« Lorsque le passé n'éclaire plus l'avenir, l'esprit marche dans les ténèbres »</span>
              </p>
              <p className="text-lg text-navy-light leading-relaxed max-w-2xl">
                <span className="text-sm uppercase tracking-widest text-gold font-bold">Alexis de Tocqueville</span>
              </p>
            </div>
            ...
            <div className="md:col-span-5 order-1 md:order-2 relative">
              ...
              <div className="relative z-10 h-[500px] w-full rounded-xl overflow-hidden shadow-xl">
                <Image
                  src="/sea.jpg"
                  alt="Pourquoi écrire son histoire"
                  fill
      ...
      <section className="py-24 bg-[#FDFBF7] relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-4xl relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-serif text-navy mb-4">Passion & Émotion</h2>
            {/* Séparateur signature */}
