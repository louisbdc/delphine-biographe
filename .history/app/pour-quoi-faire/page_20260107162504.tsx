  ...
  return (
    <>
      ...
      <section className="relative py-24 bg-navy text-cream overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full opacity-5 pointer-events-none z-[1]">
      ...
      {/* Section 1 : La Transmission (Mise en page éditoriale asymétrique) */}
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid md:grid-cols-12 gap-12 items-center">
            ...
            <div className="md:col-span-5 relative group">
              ...
              <div className="relative z-10 rounded-tl-[3rem] rounded-br-[3rem] overflow-hidden shadow-2xl aspect-[3/4]">
                 {/* Placeholder Image - Suggestion : Une photo en noir et blanc de mains qui se tiennent ou d'un vieil album */}
            ...
            <div className="md:col-span-7 md:pl-8">
              ...
              <div className="space-y-6 text-lg text-navy-light leading-relaxed">
                ...
                <blockquote className="border-l-4 border-gold pl-6 italic text-navy my-8">
      ...
      {/* Section 2 : Les 3 Piliers (Cartes Élégantes) */}
      ...
      {/* Section 3 : Le pouvoir de l'écrit (Full width image background idea) */}
      <section className="relative py-24 bg-navy overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-5xl relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-64 md:h-96 w-full rounded-2xl overflow-hidden shadow-2xl border border-white/10">
               <Image 
                 src="/to_not_forget.jpg" // Utilisation de l'image existante "Pour ne pas oublier"
