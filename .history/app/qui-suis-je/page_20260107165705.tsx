...
export default function QuiSuisJe() {
  return (
    <>
      ...
      {/* 1. HERO STANDARDISÉ (Texte centré uniquement) */}
      <section className="relative py-24 bg-[#FDFBF7] overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-4xl text-center relative z-10">
          <span className="text-gold font-bold tracking-widest uppercase text-sm mb-4 block fade-in">
            Votre Biographe
          </span>
          ...
          {/* Introduction légère centrée */}
          <p className="text-xl md:text-2xl text-navy-light max-w-2xl mx-auto font-light leading-relaxed">
             Je m'appelle <span className="font-bold text-old-rose italic">Delphine de Lapeyrière</span>. Une passionnée des mots prête à écouter votre histoire.
          </p>
        </div>
      </section>

      {/* 2. LA PRÉSENTATION (L'image arrive ici, style "Album Photo") */}
      <section className="py-12 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
           <div className="grid md:grid-cols-12 gap-12 items-center">
            
            {/* Image à gauche pour changer du texte centré du haut */}
            ...
            <div className="md:col-span-7 space-y-6 text-lg text-navy-light leading-relaxed">
               <h2 className="text-3xl font-serif text-navy mb-6">Un parcours dédié à l'écoute</h2>
               <p>
                 Je navigue entre les mots et les souvenirs. Mon parcours n'est pas linéaire, il est riche de rencontres, de voyages et d'écoutes.
               </p>
               <p>
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="flex flex-col md:flex-row gap-16 items-start">
             ...
             <div className="md:w-1/3 flex flex-col items-center text-center md:sticky md:top-32">
                ...
                <div className="w-16 h-0.5 bg-sage/50 my-4"></div>
             </div>
