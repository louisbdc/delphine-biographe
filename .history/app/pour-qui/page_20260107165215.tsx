...
export default function PourQui() {
  return (
    <>
      ...
      {/* Hero Section : Sobre et Élégante */}
      <section className="relative py-24 bg-[#FDFBF7] overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-5xl relative z-10 text-center">
          ...
          <div className="w-px h-16 bg-navy/20 mx-auto mb-8"></div>
          <p className="text-xl md:text-2xl text-navy-light max-w-3xl mx-auto leading-relaxed font-light">
